...
class SslCommerzPaymentController extends Controller
{
    ...
    public function paySK($request,$user)
    {
        ...
        $post_data['cus_add1'] = $user->profile->address;
        $post_data['cus_add2'] = $user->profile->office_address;
        $post_data['cus_city'] = $user->profile->academic_program;
        $post_data['cus_state'] = $user->profile->faculty;
        $post_data['cus_postcode'] = $user->profile->student_id;
        $post_data['cus_country'] = "BUP";
        $post_data['cus_phone'] = $user->profile->phone;
        $post_data['cus_fax'] = $user->profile->academic_session;
        // return $post_data;
