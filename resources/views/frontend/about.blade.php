                ...
                <div class="col-lg-11 m-auto">
                    ...
                    <div class="single-about-text">
                        ...
                        <p>As the association took its initial steps, it underwent a process of evolution and growth.
                            ...
                            and the cultivation of a distinct identity among its members marked the early years.
                            Leadership played a pivotal role in steering the BUPAA through challenges and seizing
                            opportunities for expansion. Significant milestones, such as scholarship programs,
                            ...
                            integral to the association's identity.
                            Beyond the university walls, the BUPAA extended its influence to the broader community
                            through philanthropic initiatives. Supporting local charities, organizing community outreach
                            programs, and leveraging the collective skills of its members for societal development
                            demonstrated the association's commitment to being a responsible and contributing citizen.
                            Like any journey, the BUPAA faced challenges. Economic fluctuations, changing societal
                            dynamics, and the evolving landscape of higher education posed obstacles that required
                            adaptability and resilience. The association's ability to navigate these challenges and
                            emerge stronger spoke volumes about the dedication of its members.</p>
                    </div>
                    ...
                    <div class="single-about-text">
                        ...
                        This inaugural achievement could take various forms, such as a groundbreaking discovery,
                            ...
                            endeavors. It exemplified the dedication of the BUP community to pushing the boundaries and
                            striving for excellence in all facets of academic and research pursuits.
                            ...
                            contributions extend far beyond the confines of the campus.
                            As a pivotal moment in BUP's history, this initial achievement laid the groundwork for
                            subsequent successes. It serves as a catalyst for the university's ongoing commitment to
                            excellence, research, and innovation. The legacy of this accomplishment is evident in BUP's
                            continued pursuit of excellence, showcasing how it has shaped the trajectory of the
                            institution and its enduring impact on the academic landscape.
                    ...
                    <div class="single-about-text">
                        ...
                        <p>Bearing witness to the perpetual evolution of academia, the Bangladesh University of
                            Professionals (BUP) welcomes a vibrant wave of change embodied by its new generation.
                        ...
                        <p>Administrators from the new generation, in leadership roles, prioritize inclusivity,
                            ...
                            catalysts for innovation, progress, and positive change, ensuring that BUP remains
                            responsive to the needs of the present and prepared for the challenges and opportunities of
                            the future.</p>
                    </div>
                    <!-- Single about text End -->
                </div>
                            ...
                            <div class="col-12 mb-4 d-flex">
                                <div class="card w-100 shadow-sm border-0">
                                    <div class="card-body text-center">
                                        <img src="{{ asset('images/'.$testimonial->image) }}" alt="{{ $testimonial->name }}" class="rounded-circle mb-3" style="width:300px;height:300px;object-fit:cover;">
                                        <i class="quote-icon d-block mb-2"></i>
                                        <strong>{{ $testimonial->message_subject }}</strong>
                                        <p class="mt-2 text-justify">{{ Str::limit($testimonial->details, 10000) }}</p>  <h5 class="mt-3 mb-0">{{ $testimonial->name }}</h5>
                    ...
                    <div class="row mb-5">
                        ...
                        @foreach($group as $testimonial)
                            <div class="col-lg-6 col-md-6 col-sm-6 mb-4 d-flex">
                                <div class="card w-100 shadow-sm border-0">
                                    <div class="card-body text-center">
                                        <img src="{{ asset('images/'.$testimonial->image) }}" alt="{{ $testimonial->name }}" class="rounded-circle mb-3" style="width:180px;height:180px;object-fit:cover;">
                                        <i class="quote-icon d-block mb-2"></i>
                                        <strong>{{ $testimonial->message_subject }}</strong>
                                        <p class="mt-2 text-justify">{{ Str::limit($testimonial->details, 500) }}</p>
