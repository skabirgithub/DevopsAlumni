    ...
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header">
                ...
                <h5 class="card-title text-primary">Update Student Profile </h5><br>
            </div>
            <div class="card-body">
                <form data-parsley-validate enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        <label>Batch*</label>
                        <input value="{{$user->profile->batch}}" required name="batch" type="text" class="form-control"
                            laceholder="Batch">
                    </div>
                    <div class="form-group">
                        <label>Student Id*</label>
                        <input value="{{$user->profile->student_id}}" required name="student_id" type="number"
                            class="form-control" laceholder="Student Id">
                    </div>
                    <div class="form-group">
                        <label>Phone*</label>
                        <input value="{{$user->profile->phone}}" required name="phone" type="text" class="form-control"
                            laceholder="Phone">
                    </div>
                    <div class="form-group">
                        <label>Address*</label>
                        <input value="{{$user->profile->address}}" required name="address" type="text"
                            class="form-control" laceholder="Address">
                    </div>
                    <div class="form-group">
                        <label>Facebook</label>
                        <input value="{{$user->profile->facebook}}" name="facebook" type="url" class="form-control"
                            placeholder="http://facebook.com">
                    </div>
                    <div class="form-group">
                        <label>LinkedIn</label>
                        <input value="{{$user->profile->linkedin}}" name="linkedin" type="url" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <textarea required name="job_details" type="text" class="form-control"
